    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`min-height:${__p(['_p5','__size'],'4.5rem') === '4.5rem' ? '50vh' : '300px'};min-width:${__p(['_p5','__size'],'4.5rem') === '4.5rem' ? '40%' : '100%'};background-image:url("./assets/mubGif.gif");`
                },
                [
            ...
            __c(
                'div',
                {
                    style:'width:100%;display:flex;justify-content:center;align-items:center;flex-direction:column;text-align:left;padding-left:50px'
                },
                [
                    __c('h1',{style:`font-weight:900;font-weight:100;font-size:${__p(['_p5','__size'],'4rem')};width:100%`},['Tokenomics']),
