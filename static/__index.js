    ...
    return __c(
        ...
        [
            ...
            __c(
                'div',
                {
                    style:'height:fit-content;width:100%;padding:60px;background:#01213c;display:flex;align-items:center;flex-direction:column;'
                },
                [
                    __c('p',{style:'font-size: .9rem;font-family:ubuntu;line-height: 1.75rem;text-align:center;font-weight:900;color:#fff;width:100vw'},[
                        '© 2024 All Right Reserved by $GAY-FISH'
                    ])
                ]
            )
        ],
    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`min-height:${__p(['navBar','l_size'],'120px')};min-width:${__p(['navBar','l_size'],'120px')};border-radius:50%;background-image:url('./assets/logo.jpeg');background-color:#0276D7;border:5px dashed #0276D7;`
                },[],{genericStyle:['bg_fit']}
            ),
            __c(
                'div',
                ...
                [
                    __SYD.nav_b_text('Who is GAY-FISH?','_p3'),
...
__SYD.buyNowBtn = () =>{
    return __c('a',{href:'https://app.uniswap.org/?chain=base',target:'blank',style:`display:${__p(['navBar','__nav_d'],'block')};padding:15px 20px; background-image:url('./assets/btn_logo.png');color:#171717;text-decoration:none;`,class:'click'},['Buy Now'],{genericStyle:['bg_fit']})
}
        ...
        ],
        {
            events:{
                onclick:() =>{
                    ...
                    {
                        case click === 'uniswap':
                            window.location = 'https://app.uniswap.org/?chain=base'
                        break;
                        default:
...
__SYD.mobileMenu = () =>{
    return __c(
        'div',
        {
            style:`height:fit-content;width:fit-content;padding:20px 10px;display:${__p(['mobileMenu','_d'],'none')};flex-direction:column;row-gap:20px;background:#d4c5c0;box-shadow:0 0 5px #171717;border-radius:10px;position:absolute;top:100%;right:0;opacity:${__p(['mobileMenu','_op'],'0')};transition:opacity .3s linear`,
            tabindex:'1',
            class:'mobile_menu'
        },
        [
            ...
            __SYD.nav_b_text('Tokenomics','_p5'),
            __SYD.nav_b_text('How to Buy','_p4'),
            __SYD.nav_b_text('Buy Now','uniswap'),
